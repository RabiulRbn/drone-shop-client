...
const Review = () => {
    ...
    const onSubmit = data => {
        ...
        console.log(newData);
        const url = `https://enigmatic-falls-89826.herokuapp.com/usersReview`;
    ...
    return (
        <div className="mt-5 p-5 mx-auto" style={{ backgroundColor: 'gray', width: '600px', borderRadius: '30px' }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <br /> <input name="designation" className="mr-5 form-control w-75" placeholder="Company's name.Designation" {...register('designation')} />
